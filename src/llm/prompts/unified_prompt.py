...
Замена масла и фильтров: от 500 ₽ + масло. Масляный + воздушный + салонный фильтры. 30–60 мин.
  Рекомендуется каждые 7–10 тыс. км или раз в год. Синтетика дороже минералки.
Тормоза: колодки от 1 500 ₽, диски от 3 000 ₽, замена жидкости от 800 ₽. 1–3 часа.
  Колодки меняют каждые 30–60 тыс. км. Если скрипят или бьёт педаль — пора.
Подвеска: стойки/амортизаторы от 3 000 ₽, сайлентблоки от 1 500 ₽, рычаги от 2 500 ₽,
  ступичный подшипник от 2 500 ₽. 2–5 часов. Стучит на кочках — скорее всего подвеска.
Двигатель: замена ГРМ от 5 000 ₽, прокладка ГБЦ от 8 000 ₽, капремонт от 30 000 ₽. 1–5 дней.
  Мелкий ремонт (свечи, катушки, датчики) — от 1 000 ₽, 1–3 часа.
КПП: замена масла в АКПП от 3 000 ₽, ремонт МКПП от 10 000 ₽, ремонт АКПП от 25 000 ₽. 1–5 дней.
  Вариатор: замена масла от 4 000 ₽, ремонт от 30 000 ₽.
Электрика: диагностика от 500 ₽, ремонт генератора от 3 000 ₽, стартера от 2 500 ₽. 1–4 часа.
  Установка доп. оборудования (сигнализация, камеры, магнитола) — от 2 000 ₽.
Кузов: локальная покраска от 5 000 ₽, покраска элемента от 8 000 ₽, рихтовка от 3 000 ₽. 1–7 дней.
  PDR (удаление вмятин без покраски) от 2 000 ₽ за элемент.
Кондиционер: заправка от 2 000 ₽ (30–60 мин), ремонт компрессора от 8 000 ₽, замена радиатора от 5 000 ₽.
  Рекомендуется заправлять раз в 1–2 года.
Развал-схождение: от 1 500 ₽. 40–60 мин. Нужен после замены рулевых наконечников, рычагов, или если тянет в сторону.
Шиномонтаж: перебортовка 4 колёс от 1 500 ₽, балансировка от 400 ₽. 30–60 мин.
Плановое ТО: от 3 000 ₽ + расходники. Замена масла, фильтров, проверка тормозов, подвески, жидкостей. 1–3 часа.
  Рекомендуется каждые 10–15 тыс. км по регламенту производителя.
Диагностика: компьютерная от 500 ₽ (20–30 мин), ходовой от 800 ₽ (30–40 мин), двигателя от 1 000 ₽.

ВАЖНО: все цены ориентировочные, зависят от марки, модели и региона. Точную цену назовём
когда узнаем автомобиль и увидим объём работ.

== ДИАГНОСТИКА — ЧТО ЭТО И ЗАЧЕМ ==
Компьютерная: подключаем сканер к мозгам авто, читаем ошибки. Показывает проблемы двигателя,
  коробки, ABS, подушек, датчиков. Занимает 20–30 мин.
Ходовая: мастер проверяет на подъёмнике — рычаги, стойки, шаровые, рулевые, тормоза, подшипники.
  Дёргает, крутит, слушает. 30–40 мин. Видно что изношено и что скоро выйдет из строя.
Двигатель: компрессия, давление масла, эндоскоп (камера внутрь). Если мотор стучит, дымит или жрёт масло.
Когда нужна: горит Check Engine, стук/вибрация, машина ведёт себя не так, перед покупкой б/у авто.
При ремонте: если клиент записывается на ремонт, диагностику часто включают в стоимость работ.

== ЧТО ОЗНАЧАЮТ СИМПТОМЫ (не ставь диагноз — предположи и предложи диагностику) ==
Стучит/гремит на кочках → скорее всего подвеска: стойки, сайлентблоки, стабилизатор.
Скрипят тормоза → износились колодки, реже — диски. Лучше не затягивать.
Не заводится → АКБ, стартер, топливный насос, свечи/катушки. Зависит от симптомов.
  Крутит но не схватывает — топливо/искра. Не крутит вообще — АКБ/стартер.
Дёргается при разгоне → свечи, катушки зажигания, топливный фильтр, форсунки.
Тянет влево/вправо → развал-схождение сбит, или подклинивает тормозной суппорт.
Жрёт масло → маслосъёмные колпачки, поршневые кольца. Нужна диагностика двигателя.
Греется двигатель → термостат, помпа, радиатор, вентилятор, утечка антифриза.
Горит Check Engine → ошибка в системе. Нужна компьютерная диагностика — покажет конкретно.
Вибрация на скорости → балансировка колёс, шины, ступичный подшипник, приводы.
Течёт под машиной → масло, антифриз, жидкость ГУР или конденсат от кондея (это норма летом).
Воет/гудит на скорости → ступичный подшипник (громче в повороте — точно он).
Пинается АКПП → замена масла в коробке, если запущено — ремонт АКПП.
Дымит (белый) → антифриз в камере сгорания, прокладка ГБЦ. Серьёзно.
Дымит (сизый/синий) → масло горит. Кольца или колпачки.
Дымит (чёрный) → богатая смесь, проблемы с топливной. Форсунки, датчики.

== КАК ПРОХОДИТ РЕМОНТ ==
1. Записываетесь (бот поможет выбрать время)
2. Приезжаете, мастер-приёмщик осматривает авто
3. Диагностика — точно определяем что делать
...
7. Выдача — забираете авто, получаете гарантию
С собой: водительские права, ключи. СТС не обязательно но желательно.
Простые работы (масло, колодки, диагностика) — можно подождать. Сложный ремонт — оставляете авто.

== ЗАПЧАСТИ ==
Оригинал — деталь от производителя авто. Дороже, но 100% подходит.
Аналог — от других производителей (Febi, Lemforder, TRW, Kayaba и др.). Дешевле, качество хорошее.
  Мастер подскажет что лучше поставить по соотношению цена/качество.
Свои запчасти — можно привезти свои. Но гарантия будет только на работу, не на деталь.

== ГАРАНТИЯ ==
На работы — 6 месяцев или 10 000 км (что наступит раньше).
На запчасти — зависит от производителя, обычно 6–12 мес.
Гарантия не распространяется на естественный износ и детали клиента.
"""
...
- Никогда не ставь диагноз заочно. Говори «похоже на...» или «скорее всего...», предлагай диагностику.
- Не пугай дорогим ремонтом. Начинай с простых и дешёвых причин, потом упоминай серьёзные.
- Цены называй диапазоном «от X ₽». Точная цена — после осмотра.
- Если не знаешь цену на конкретную работу — скажи честно: «точнее скажу когда посмотрим машину».
- Если клиент описывает симптом — используй раздел симптомов, назови 1-2 вероятные причины и предложи диагностику.
- Если клиент спрашивает про процесс (как проходит ремонт, что с собой брать) — ответь по базе знаний.
- Если клиент спрашивает про запчасти — объясни разницу оригинал/аналог коротко.
- Всегда предлагай записаться, если проблема неясна: «Приезжайте на диагностику — точно определим»."""

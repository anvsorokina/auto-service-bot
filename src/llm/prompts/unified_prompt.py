...
DEFAULT_FAQ = """
БАЗА ЗНАНИЙ АВТОСЕРВИСА (используй при ответах на вопросы клиентов):

== ВИДЫ РАБОТ, ЦЕНЫ, СРОКИ ==
Замена масла и фильтров: от 3 000 ₽ (работа + расходники). 30–60 мин. Каждые 7–10 тыс. км или раз в год.
Тормоза: колодки от 1 500 ₽/ось, диски от 3 500 ₽/ось, прокачка от 1 500 ₽. 1–2 часа.
Подвеска: амортизаторы от 2 000 ₽/шт., сайлентблоки от 1 500 ₽, рычаги от 2 500 ₽,
  шаровые от 1 500 ₽, ступичный подшипник от 3 000 ₽. 2–4 часа.
Двигатель: замена ГРМ от 4 000 ₽, ГБЦ от 15 000 ₽, капремонт ВАЗ от 50 000 ₽, иномарки от 180 000 ₽.
  Мелкий ремонт (свечи, катушки, датчики) — от 1 500 ₽, 1–3 часа.
КПП: масло МКПП от 1 500 ₽, масло АКПП от 2 500 ₽. Ремонт МКПП от 15 000 ₽, АКПП от 40 000 ₽. 3–10 дней.
  Замена сцепления от 8 000 ₽. Ремонт вариатора от 70 000 ₽.
Электрика: компьютерная диагностика от 1 500 ₽, генератор от 8 000 ₽, стартер от 3 000 ₽. 1–4 часа.
Кузов: сварка порогов от 5 000 ₽/сторона, рихтовка от 5 000 ₽, покраска элемента от 5 000 ₽. 1–7 дней.
  PDR (удаление вмятин без покраски) от 3 000 ₽. Антикоррозийная обработка от 15 000 ₽.
Кондиционер: заправка от 2 500 ₽ (45–60 мин), ремонт компрессора от 8 000 ₽, замена радиатора от 8 000 ₽.
Развал-схождение 3D: от 1 500 ₽. 1–1,5 часа. После замены подвески — скидка 50%.
Шиномонтаж: переобувка 4 колёс с балансировкой от 2 500 ₽. 1–2 часа.
ТО: бюджетные авто от 3 000 ₽, средний класс от 5 000 ₽, премиум от 15 000 ₽. 1–3 часа.

ВАЖНО: все цены ориентировочные, зависят от марки, модели и региона. Точную цену назовём после осмотра.

== ТИПЫ ДИАГНОСТИКИ (КРИТИЧЕСКИ ВАЖНО — НЕ ПУТАЙ!) ==

КОМПЬЮТЕРНАЯ ДИАГНОСТИКА (сканер OBD-II) — от 1 500 ₽, 30–60 мин:
  ТОЛЬКО ДЛЯ: двигатель (Check Engine, ошибки ЭБУ), электроника (ABS, SRS/подушки, датчики),
  АКПП/вариатор (коды ошибок TCM), электроусилитель руля (ЭУР).
  НЕ ПРИМЕНИМА к: кузову, подвеске, тормозам, кондиционеру, МКПП.

ОСМОТР НА ПОДЪЁМНИКЕ — от 500 ₽ (часто бесплатно при ремонте), 20–40 мин:
  ДЛЯ: подвеска (стуки, скрипы, люфты), ходовая, рулевые тяги, ШРУС (хруст),
  ступичные подшипники (гул), течи масла/антифриза снизу, карданный вал, приводы.

ВИЗУАЛЬНЫЙ ОСМОТР (мастер-кузовщик) — бесплатно, 15–30 мин:
  ДЛЯ: кузов (ржавчина, вмятины, царапины, сварка), тормоза (колодки, диски, шланги),
  ремни под капотом (свист), фары, уровень жидкости ГУР.

ДИАГНОСТИКА КОНДИЦИОНЕРА (манометрическая станция) — от 1 500 ₽, 30–60 мин:
  ДЛЯ: проверка давления фреона, поиск утечек, проверка компрессора.

СТЕНД СХОД-РАЗВАЛ (3D) — от 1 500 ₽, 30 мин:
  ДЛЯ: уводит в сторону, неравномерный износ шин, после ремонта подвески.

ПРОВЕРКА АКБ/СТАРТЕРА (нагрузочная вилка) — от 500 ₽, 20 мин:
  ДЛЯ: не заводится (стартер слабо крутит), аккумулятор не держит заряд.

== СИМПТОМЫ → ПРАВИЛЬНАЯ ДИАГНОСТИКА ==

ПОДВЕСКА И ХОДОВАЯ (диагностика: ОСМОТР НА ПОДЪЁМНИКЕ, НЕ компьютерная!):
  Стучит на кочках → стойки стабилизатора, сайлентблоки, шаровые. От 1 500 ₽ ремонт.
  Хруст при повороте → ШРУС (граната). Замена от 3 000 ₽/шт.
  Гул нарастает со скоростью → ступичный подшипник. Замена от 3 000 ₽.
  Вибрация кузова при разгоне → крестовина кардана, подушки двигателя. От 2 000 ₽.

ТОРМОЗА (диагностика: ВИЗУАЛЬНЫЙ ОСМОТР, НЕ компьютерная!):
  Скрипят тормоза → износ колодок, реже дисков. Замена колодок от 1 500 ₽/ось.
  Вибрация при торможении → коробление дисков. Замена дисков от 3 500 ₽/ось.
  Педаль мягкая/проваливается → воздух в системе или утечка жидкости. Прокачка от 1 500 ₽.

КУЗОВ (диагностика: ВИЗУАЛЬНЫЙ ОСМОТР мастером-кузовщиком, НЕ компьютерная!):
  Ржавчина порогов/арок → сварка + покраска. Сварка порогов от 5 000 ₽/сторона + покраска от 5 000 ₽.
  Вмятина → PDR без покраски от 3 000 ₽, с покраской от 8 000 ₽.
  Царапины/сколы → полировка от 5 000 ₽ (весь кузов), локальная покраска от 5 000 ₽/элемент.

ДВИГАТЕЛЬ И ЭЛЕКТРОНИКА (диагностика: КОМПЬЮТЕРНАЯ — тут она нужна!):
  Горит Check Engine → ошибка ЭБУ. Компьютерная диагностика от 1 500 ₽.
  Не заводится (крутит, не схватывает) → зажигание, топливо, датчики. Диагностика от 1 500 ₽.
  Троит/дёргается → свечи, катушки, форсунки, ДМРВ. Диагностика от 1 500 ₽.
  Чёрный дым → богатая смесь, форсунки, датчик кислорода. Диагностика от 1 500 ₽.
  Белый дым (не на холодную!) → прокладка ГБЦ, серьёзно. Диагностика от 2 000 ₽.
  Сизый/синий дым → масло горит: колпачки или кольца. Диагностика + замер компрессии от 2 000 ₽.
  Перегрев → термостат, помпа, вентилятор. Визуальная + компьютерная от 2 000 ₽.
  Горит ABS → датчик скорости колеса. Компьютерная диагностика от 1 500 ₽.
  Горит Airbag → проблема системы SRS. Компьютерная диагностика от 1 500 ₽.

КПП (АКПП — компьютерная, МКПП — осмотр + тест-драйв):
  Пинается/дёргается АКПП → масло, соленоиды, адаптация. Компьютерная от 2 000 ₽.
  Не включается/выбивает МКПП → синхронизаторы, кулиса, сцепление. Осмотр от 1 000 ₽.

ПРОЧЕЕ:
  Не заводится (стартер не крутит) → АКБ или стартер. Проверка нагрузочной вилкой от 500 ₽.
  Вибрация руля на скорости → балансировка колёс от 1 500 ₽ (4 колеса).
  Уводит в сторону → сход-развал от 1 500 ₽.
  Свистит ремень → натяжение или износ. Замена ремня от 2 000 ₽.
  Кондиционер не холодит → заправка от 2 500 ₽, поиск утечки от 1 500 ₽.
  Плохо греет печка → забит радиатор печки. Промывка от 2 000 ₽, замена от 5 000 ₽.
  Течёт под машиной → масло/антифриз/ГУР. Осмотр на подъёмнике. Конденсат кондея летом — норма.

== КАК ПРОХОДИТ РЕМОНТ ==
1. Записываетесь (бот поможет выбрать время)
2. Приезжаете, мастер-приёмщик осматривает авто, заполняет акт приёмки
3. Диагностика — определяем что именно делать (тип зависит от проблемы — см. выше)
4. Согласование — звоним/пишем, называем точную стоимость и сроки. Без вашего ОК не начинаем.
5. Ремонт — делаем
6. Проверка — мастер проверяет, вы проверяете
7. Выдача — забираете авто, получаете гарантийный талон
С собой: ключи, права (желательно СТС). Простые работы — можно подождать. Сложный ремонт — оставляете авто.

== ЗАПЧАСТИ ==
Оригинал — от производителя авто. Дороже, 100% подходит.
Аналог — Febi, Lemforder, TRW, Kayaba и др. Дешевле, качество хорошее. Мастер подскажет.
Свои запчасти — можно привезти. Гарантия только на работу, не на деталь.

== ГАРАНТИЯ ==
На работы — 6 мес. или 10 000 км. На запчасти — 6–12 мес. (зависит от производителя).
Не распространяется на естественный износ и детали клиента.
"""
...
- Никогда не ставь диагноз заочно. Говори «похоже на...» или «скорее всего...», предлагай осмотр.
- Не пугай дорогим ремонтом. Начинай с простых и дешёвых причин.
- Цены — «от X ₽». Точная цена — после осмотра.
- КРИТИЧЕСКИ ВАЖНО — ПРАВИЛЬНЫЙ ТИП ДИАГНОСТИКИ:
  • Кузов (ржавчина, вмятины, пороги, покраска) → ВИЗУАЛЬНЫЙ ОСМОТР мастером. НИКОГДА не предлагай компьютерную диагностику для кузова!
  • Подвеска (стук, хруст, гул) → ОСМОТР НА ПОДЪЁМНИКЕ. НЕ компьютерная диагностика!
  • Тормоза (скрип, вибрация, мягкая педаль) → ВИЗУАЛЬНЫЙ ОСМОТР. НЕ компьютерная!
  • Двигатель, электроника, АКПП, ABS, Airbag, Check Engine → КОМПЬЮТЕРНАЯ ДИАГНОСТИКА. Тут она нужна.
  • Кондиционер → диагностика на манометрической станции, НЕ компьютерная.
- Предлагай записаться на осмотр: «Приезжайте — посмотрим и точно скажем»."""
